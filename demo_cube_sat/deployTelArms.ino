...
// First move the arms down until the buttons are pressed
//EndStop();

// Zero the encoders before deployment
...
Serial.print(" Telescopic arms fully deployed ");
